...
public class CurrencyController {
     ...
     */
    @GetMapping("/names")
    public List<String> getAllCurrencyNamesAndSymbols() {
     ...
     * Example: GET /api/currency/history?base=USD&to=EUR&days=1
     */
    @GetMapping("/history")
    ...
    /**
     * Find a currency by keywords
     * Example: GET /api/currency/findCurrency/AUD
     */
    @GetMapping("/findCurrency/{keyWord}")
    public List<Currency> findCurrency(@PathVariable String keyWord){
        return converterService.findCurrency(keyWord);
    }
}
